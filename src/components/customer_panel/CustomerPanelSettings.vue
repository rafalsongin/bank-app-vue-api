  ...
  <div class="container my-4">
    ...
    <form @submit.prevent="updateSettings">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="email" id="email" :value="currentCustomer.email" class="form-control" disabled>
        </div>
      </div>
      <div class="mb-3 row">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="text" id="accountApprovalStatus" :value="currentCustomer.accountApprovalStatus" class="form-control" disabled>
        </div>
      </div>
      <div class="mb-3 row">
...
export default {
  ...
  methods: {
    async updateSettings() {
      ...
      await customerStore.updateCustomerDetails(updatedDetails);
      this.$emit('customerUpdated', updatedDetails);
    },
